...
namespace LatexApp0
{
        ...
        private PrintDocument CreateDocument()
        {
         ...
         private void PrintPage(object sender, PrintPageEventArgs e)
         {
            ...
            g.DrawRectangle(Pens.Black, topside,topup, contentWidth, contentHeight);
             ...
             g.DrawString($" หนึ่งยางเช่า", headerFont, Brushes.Black, marginLeft+50, y);
    ...
    textSize.Height+3
            ...
            g.DrawString($"1000 บาท", boldFont, Brushes.Black, col2ValueX-15, y, rightAlign);
            ...
            z += section;
            // Name (left) {_bill.CustomerName}
            g.DrawString($" หนึ่งยางเช่า", headerFont, Brushes.Black, marginRight+50, z);
            ...
            g.DrawString($"120 kg", normalFont, Brushes.Black, col1ValueX2, z, rightAlign);

            g.DrawString("ถัง", normalFont, Brushes.Black, col2LabelX2, z);
            g.DrawString($"12 kg", normalFont, Brushes.Black, col2ValueX2, z, rightAlign);

            z += line2;

            // Row 2{_bill.Price:N0}
            g.DrawString("น้ำหนักสุทธิ", normalFont, Brushes.Black, col1LabelX2, z);
            g.DrawString($"108 kg", normalFont, Brushes.Black, col1ValueX2, z, rightAlign);
            g.DrawString("เปอร์เซ็น", normalFont, Brushes.Black, col2LabelX2, z);
            g.DrawString($"36 %", normalFont, Brushes.Black, col2ValueX2, z, rightAlign);
            z += line2;
            g.DrawString("แห้ง", normalFont, Brushes.Black, col1LabelX2, z);
            g.DrawString($"22.2 kg", normalFont, Brushes.Black, col1ValueX2, z, rightAlign);
            g.DrawString("ราคา", normalFont, Brushes.Black, col2LabelX2, z);
            g.DrawString($"2014 บาท", normalFont, Brushes.Black, col2ValueX2, z, rightAlign);

            z += line2;

            g.DrawString("เป็นเงิน", normalFont, Brushes.Black, col1LabelX2, z);
            g.DrawString($"2000 บาท", normalFont, Brushes.Black, col1ValueX2, z, rightAlign);
            z += line2;
    ...
    textSize.Width + 7,
    textSize.Height+3);
            g.DrawString($"1000 บาท", boldFont, Brushes.Black, col2ValueX2, z, rightAlign);
        }
